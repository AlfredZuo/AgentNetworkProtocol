...
This layer provides the basic communication function between Agents, including all the functions mentioned above in this draft.
...
This layer SHALL provide the following functions:
